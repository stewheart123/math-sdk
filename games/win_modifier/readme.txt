...
* X1 — multiply current win by 1
* X2 — multiply current win by 2
* X3 — multiply current win by 3
...
* Paytable values (placeholder amounts in game_config.py)
* Reel and modifier strip weights for RTP tuning
